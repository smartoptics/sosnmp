...
# ASN.1 source http://mibs.pysnmp.com:80/asn1/SNMP-VIEW-BASED-ACM-MIB
...
vacmSecurityToGroupTable = MibTable(
    (1, 3, 6, 1, 6, 3, 16, 1, 2),
)
if mibBuilder.loadTexts:
...
vacmSecurityToGroupEntry = MibTableRow(
...
vacmSecurityModel = MibTableColumn(
...
vacmSecurityName = MibTableColumn(
...
vacmSecurityToGroupStorageType = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 16, 1, 2, 1, 4), StorageType().clone("nonVolatile")
).setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
vacmSecurityToGroupStatus = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 16, 1, 2, 1, 5), RowStatus()
).setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    vacmAccessEntry.setDescription(
        "An access right configured in the Local Configuration Datastore (LCD) authorizing access to an SNMP context. Entries in this table can use an instance value for object vacmGroupName even if no entry in table vacmAccessSecurityToGroupTable has a corresponding value for object vacmGroupName. "
    )
vacmAccessContextPrefix = MibTableColumn(
...
vacmAccessStorageType = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 8), StorageType().clone("nonVolatile")
).setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
vacmViewTreeFamilyTable = MibTable(
...
vacmViewTreeFamilyViewName = MibTableColumn(
...
vacmViewTreeFamilySubtree = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 2), ObjectIdentifier()
)
if mibBuilder.loadTexts:
...
vacmViewTreeFamilyMask = MibTableColumn(
...
vacmViewTreeFamilyType = MibTableColumn(
...
vacmViewTreeFamilyStorageType = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 5), StorageType().clone("nonVolatile")
).setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
vacmViewTreeFamilyStatus = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 6), RowStatus()
).setMaxAccess("read-create")
if mibBuilder.loadTexts:
