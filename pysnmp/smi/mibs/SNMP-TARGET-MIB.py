...
# ASN.1 source http://mibs.pysnmp.com:80/asn1/SNMP-TARGET-MIB
...
snmpTargetAddrEntry = MibTableRow(
...
snmpTargetAddrTagList = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 6), SnmpTagList()
).setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
snmpTargetParamsEntry = MibTableRow(
