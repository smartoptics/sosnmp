...
snmpEngineTime = (
    MibScalar(
        ...
        SnmpEngineTime().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)),
    )
    .setUnits("seconds")
    .setMaxAccess("read-only")
)
...
snmpEngineMaxMessageSize = MibScalar(
    ...
    Integer32().subtype(subtypeSpec=ValueRangeConstraint(484, 2147483647)),
).setMaxAccess("read-only")
if mibBuilder.loadTexts:
